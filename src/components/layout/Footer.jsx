...
const footerLinks = {
  shop: {
    ...
    links: [
      ...
      { title: 'Fragrance', href: '/shop?category=fragrance' },
    ],
  },
  company: {
    title: 'Company',
...
export function Footer() {
  return (
    <footer className="bg-beauty-dark text-white relative overflow-hidden">
      {/* Top gradient line */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              />
              <SocialIcon
                path="M10 0C4.482 0 0 4.482 0 10c0 5.518 4.482 10 10 10s10-4.482 10-10C20 4.482 15.518 0 10 0zm2.188 14.807l-2.387-1.607-1.265 1.278h-1.19l2.146-2.16-2.146-1.346v-1.183l3.65 2.136-1.217-3.965h1.19l2 3.008 2-3.008h1.19l-2.877 4.326 2.387 1.608v1.183l-3.65-2.136 1.184 1.424v2.136h-1.19v-1.364l-1.59-1.913z"
                label="YouTube"
                href="#"
              />
            </div>
