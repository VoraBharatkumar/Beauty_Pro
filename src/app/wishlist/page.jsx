  ...
  return (
    <div className="luna-gradient min-h-screen pt-16 md:pt-20">
      <div className="luna-container section-padding">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10 md:mb-12">
          <h1 className="font-playfair text-3xl sm:text-4xl md:text-5xl text-luna-dark mb-4">My Wishlist</h1>
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div>
                ...
                <Button variant="primary" size="sm" className="w-full text-xs md:text-sm" onClick={() => handleMoveToCart(item)}>
                  Move to Cart
                </Button>
              </div>
            </motion.div>
